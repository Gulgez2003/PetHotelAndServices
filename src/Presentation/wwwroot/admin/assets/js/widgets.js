(function($) {
    ...
    var gradientStroke = ctx.createLinearGradient(0, 0, 0, 240);
    gradientStroke.addColorStop(0, '#F7931A');

    var gradientFill = ctx.createLinearGradient(0, 0, 0, 240);
    gradientFill.addColorStop(0, "rgb(255, 76, 1)");
    gradientFill.addColorStop(1, "rgb(255, 76, 1)");
    ...
    var gradientStroke2 = ctx.createLinearGradient(0, 0, 0, 240);
    gradientStroke2.addColorStop(0, '#F7931A');

    var gradientFill2 = ctx.createLinearGradient(0, 0, 0, 240);
    ...
    var gradientStrokeZCash = zCashCtx.createLinearGradient(0, 0, 0, 240);
    gradientStrokeZCash.addColorStop(0, '#F7931A');

    var gradientFillZCash = zCashCtx.createLinearGradient(0, 0, 0, 240);
    gradientFillZCash.addColorStop(0, "rgb(255, 76, 1)");
    gradientFillZCash.addColorStop(1, "rgb(255, 76, 1)");
    ...
    var gradientStrokePeercoin = peerCoinCtx.createLinearGradient(0, 0, 0, 240);
    gradientStrokePeercoin.addColorStop(0, '#F7931A');

    var gradientFillPeercoin = peerCoinCtx.createLinearGradient(0, 0, 0, 240);
